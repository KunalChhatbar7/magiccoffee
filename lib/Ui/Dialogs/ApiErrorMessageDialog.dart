...
class ApiErrorMessageDialog extends StatefulWidget {
  final String? title, descriptions;

  const ApiErrorMessageDialog({
    Key? key,
    this.title,
    this.descriptions,
  }) : super(key: key);
  ...
  @override
  _ApiErrorMessageDialogState createState() => _ApiErrorMessageDialogState();
}

class _ApiErrorMessageDialogState extends State<ApiErrorMessageDialog> {
  @override
